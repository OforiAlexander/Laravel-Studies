        ...
        <div class="relative lg:inline-flex items-center bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: false }" @click.away=" show= false">
                ...
                <button @click="show = !show "
                    class=" appearance-none bg-transparent py-2 pl-3 pr-9 text-sm font-semibold w-full lg:w-32 text-left flex lg:inline-flex">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 mt-2 rounded-xl w-full z-50" style="display:none:">
                    <a href="/"
                        class="block text-left text-yellow-600 px-3 text-sm leading-5 focus:bg-blue-500 hover:bg-blue-500 hover:text-white focus:text-white">
                        All
                    </a>
                    ...
                    @foreach ($categories as $category)
                        <a href="/categories/{{ $category->slug }}"
                            class="block text-left px-3 text-sm leading-5 focus:bg-blue-500 hover:bg-blue-500 hover:text-white focus:text-white
